...
type TaskMessage struct {
	...
	// Time when the task created in success in Unix time,
	// the number of seconds elapsed since January 1, 1970 UTC.
	CreatedAt int64 `protobuf:"varint,15,opt,name=created_at,json=createdAt,proto3" json:"created_at,omitempty"`
	// Time when the task processed in success in Unix time,
	// the number of seconds elapsed since January 1, 1970 UTC.
	ProcessedAt int64 `protobuf:"varint,16,opt,name=processed_at,json=processedAt,proto3" json:"processed_at,omitempty"`
	// Time when the task canceled in success in Unix time,
	// the number of seconds elapsed since January 1, 1970 UTC.
...
func (x *TaskMessage) GetCanceledAt() int64 {
	if x != nil {
		return x.CanceledAt
	}
	return 0
...
var file_asynq_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xea, 0x03, 0x0a, 0x0b, 0x54, 0x61, 0x73, 0x6b, 0x4d, 0x65,
	...
	0x0a, 0x0c, 0x70, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x65, 0x64, 0x5f, 0x61, 0x74, 0x18, 0x10,
	0x20, 0x01, 0x28, 0x03, 0x52, 0x0b, 0x70, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x65, 0x64, 0x41,
	0x74, 0x12, 0x1f, 0x0a, 0x0b, 0x63, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x65, 0x64, 0x5f, 0x61, 0x74,
	0x18, 0x11, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0a, 0x63, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x65, 0x64,
